function onDepositCoin(transaction) {
    ...
    var newTransaction = getFactory().newConcept('com.s00d.coin.network', 'CoinTransaction')
    ...
    return getAssetRegistry('com.s00d.coin.network.Vault')
  ...
  function onTransferCoin(transaction) {
    ...
    var sendTransaction = getFactory().newConcept('com.s00d.coin.network', 'CoinTransaction')
    ...
    var receiveTransaction = getFactory().newConcept('com.s00d.coin.network', 'CoinTransaction')
  ...
  function sendEvent(msg) {
    var coinEvent = getFactory().newEvent('com.s00d.coin.network', 'TransactionCompleted')
    coinEvent.msg = msg
    emit(coinEvent)
  }